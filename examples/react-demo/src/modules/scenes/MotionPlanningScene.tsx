      ...
      {results.some(r => r.result) && (
        <div style={{ marginTop: 8 }}>
          ...
          {(() => {
            ...
            return (
              <div style={{ marginTop: 8, padding: 10, background: THEME.surface, borderRadius: 4 }}>
                {/* Prominent planning-time headline */}
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 8 }}>
                  <span style={{
                    ...
                    fontWeight: 800,
                    lineHeight: 1,
                    color: ALGORITHM_COLORS[fastest.planner],
                  }}>
                    {fastest.result?.totalTimeMs.toFixed(1)}ms
                  </span>
    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: THEME.background }}>
      ...
      <div style={{ flex: 1, display: 'flex', gap: 12, padding: 12, minHeight: 0 }}>
        ...
        <div style={{ flex: 1, borderRadius: 8, overflow: 'hidden', border: `1px solid ${THEME.primary}30` }}>
          <RoboViz config={{ scene: { background: THEME.background }, camera: { position: { x: 2.1, y: 1.7, z: 1.5 } } }}>
            <SceneContent
