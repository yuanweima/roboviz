...
/**
 * Tool offset configuration (Z-up): a generic 150mm tool tip along tool Z-axis,
 * so IK targets the tool center point (TCP) rather than the flange.
 *
...
function IKDemoSceneContent({ urdfContent }: { urdfContent: string }) {
  ...
  const {
    ...
    toolOffset: TOOL_OFFSET, // Apply tool offset
    enabled: true,
  ...
  return (
    <div className="module-container">
      <div className="module-header">
        <h2>Interactive Inverse Kinematics</h2>
        <p>
          trajx solves the <strong>analytical IK</strong> for the Fanuc LR&nbsp;Mate in real
          time — drag the target (sliders on the right) and the green ghost arm snaps to a
          reachable joint configuration, with live reachability status.
        </p>
      </div>
